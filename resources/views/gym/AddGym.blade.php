          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Pincode *</label>
                 <input type="number" name="pincode" id="pincode" class="form-control" oninput="GetDet()">
                ...
                <div class="form-group">
                  <label>Area *</label>
                 <select class="form-control select2 select2-hidden-accessible" name="area" data-placeholder="Choose area" id="area" tabindex="-1" aria-hidden="true">
                <option selected label="Choose area"></option>
              </select>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Address *</label>
                  <textarea class="form-control" rows="3" cols="3"  id="address"></textarea>
                </div>

                <div class="form-group">
                  <label>Plans *</label>
                  <select name="plan" id="plan" class="form-control" onchange="GetValidity(this)">
                    <option value="">Choose plan</option>
                    @foreach($plans as $p)
                    <option value="{{$p->id}}" data-month="{{$p->month}}">{{$p->name}} - ({{$p->month}} months) , <br>
                      Actual Fee : Rs.{{$p->actual_fee}} , <br>
                      Minimum Fee : Rs.{{$p->minimum_fee}}
                    </option>
                    @endforeach
                  </select>
                </div>
        ...
        if(pincode.length==6)
        {
            ...
            if(status=='01')
            {
              ...
              for (var i = 0; area.length>i; i++) {
                  $("#area").append(new Option(area[i], area[i]));
                  }
              }else
              {
                $("#pincode").prop('disabled', false);
