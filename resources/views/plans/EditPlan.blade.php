          ...
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Months *</label>
                  <input type="number" name="month" id="month" class="form-control" value="{{$plan->month}}">
                </div>
              ...
              <div class="col-md-6">
               ...
               <div class="form-group">
                 ...
                 <input type="number" name="afee" id="afee" class="form-control" value="{{$plan->actual_fee}}">
                </div>
                <div class="form-group">
                  <label>Minimum Fee (Rs.) *</label>
                 <input type="number" name="mfee" id="mfee" class="form-control" value="{{$plan->minimum_fee}}">
                </div>
              </div>
